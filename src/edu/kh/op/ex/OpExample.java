...
public class OpExample { // 예제 코드 작성용 클래스
	...
	public void ex2() {
		...
		// Scanner는 같은 패키지 내에 있지 않기 때문에 import(수입) 해와야 한다
		
		System.out.print("정수 입력 1 : ");
		int input1 = sc.nextInt(); // 다음 입력되는 정수를 읽어욤
	...
	public void ex5() {
		// 논리 연산자 : &&(and), ||(or)
		// && 연산자 : 둘다 true면 true, 나머지는 false
		// 와, 그리고, ~면서, ~이면서, ~부터 ~ 까지, ~사이
		
		// ex) 사과와 바나나, 사과 그리고 바나나
	...
	public void ex8() {
		...
		* String str1 = "양수입니다"
		* String str2 = "음수입니다"
		* String result1 = input >= 0 ? str1 : str2;
		* System.out.println(result1);
		* 
		* 
		*
